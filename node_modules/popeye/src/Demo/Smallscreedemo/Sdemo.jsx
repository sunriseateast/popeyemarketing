    ...
    return(
        <div className="my-[50px]">
            <div className="flex flex-col gap-y-[50px]">      
                <div>
                    <p className="text-[30px] my-[10px]">Book a Demo</p> 
                    <div className="bg-[#1A1A1D] px-[25px] py-[50px] rounded-xl relative my-[20px]">
                            ...
                            <div className="p-[10px]">
                                {
                                    ...
                                    <>
                                        <button onClick={(e)=>formSubmit(e)} type="submit" className={`bg-slate-100 text-black p-[10px] rounded`}>Book Now</button>
                                    </>
                                }
                            </div>
                ...
                <div className="">
                    ...
                    <div className="h-[35px] w-[35px] mt-[20px] mx-[10px]">
                        <Plant/>
                    </div>
                </div>
            </div>
