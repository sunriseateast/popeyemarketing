...
function Sidea(){
    ...
    return(
        <div className="my-[100px]">
            <div className="bg-slate-100 flex items-center justify-center max-w-[90px] rounded-[200px] text-black p-[5px]">
                <p className="text-center text-[10px]">know us</p>
                ...
                <div className="max-h-[350px] max-w-[400px] border border-zinc-700 rounded-[30px] overflow-hidden">
                    <div className="flex flex-col justify-center">
                        <div className="max-h-[200px] max-w-[400px] p-[100px] rounded-[30px] border-b border-zinc-700 overflow-hidden">
                            <div ref={circleRef}>
                                <div className="h-[350px] w-[350px] -translate-x-[100px] text-zinc-800 outer-circle">
                                    <Circle/>
                                </div>
                                <div className="text-zinc-800 stroke-slate-100 -translate-y-[300px]">
                                    <Circle/>
                                </div>
                                <div className="translate-x-[50px] -translate-y-[490px] h-[60px] w-[60px]">
                                    <Doc/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="max-h-[200px] max-w-[400px] p-[100px] rounded-[30px] border-b border-zinc-700 overflow-hidden">
                            <div ref={rectangleRef}>
                                <div className="h-[330px] w-[330px] -translate-x-[90px] -translate-y-[100px] text-zinc-800 outer-rectangle">
                                    <Rectangle/>
                                </div>
                                <div className="h-[200px] w-[200px] -translate-x-[25px] -translate-y-[310px] text-zinc-800 stroke-slate-100">
                                    <Rectangle/>
                                </div>
                                <div className="h-[60px] w-[60px] -translate-y-[510px] translate-x-[45px]">
                                    <Danger/>
                                </div>
                            </div>
                        </div>
