...
function Ssupport(){
    return(
        <div className="my-[50px]">
            <div className="">
                <div>
                    <p className="text-[30px] my-[10px]">
                        Get a Support
                    </p>
                    <p>
                        Our support team is available to assist you from 10:30 AM to 7:00 PM, Monday to Saturday.
                        Whether you need help with setup, billing, or technical issues, we’re here for you.
                        Feel free to reach out during working hours and we’ll respond promptly.
                        For queries outside office hours, please leave a message — we’ll get back to you the next business day.
