...
<div className="my-[100px]">
    <div>
        <div className="relative grid content-center justify-center max-h-[430px] max-w-[340px] p-[150px] rounded-xl bg-white overflow-hidden">
            <div className="h-[150px] w-[150px] rounded-[100px] bg-slate-100 reseller-circle"></div>
