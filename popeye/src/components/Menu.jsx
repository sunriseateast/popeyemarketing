...
function Menu({isOpen,props,tip}){
    ...
    return(
        <nav className={props}>
            <a href="#" className={`opacity-0 ${isOpen ? 'opacity-100 transition delay-100 duration-100 ease-in-out -translate-y-6':'transition ease-in-out'} md:opacity-100`} onMouseEnter={()=>enter('Softwares')}>Softwares</a>
            ...
            <a href="#" className={`opacity-0 ${isOpen ? 'opacity-100 transition delay-300 duration-300 ease-in-out -translate-y-6':'transition ease-in-out'} md:opacity-100`} onMouseEnter={()=>enter('Book a Demo')}>Book a Demo</a>
        </nav>
    )
}
